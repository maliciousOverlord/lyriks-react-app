      ...
      <div className="mb-10">
        ...
        <div className="mt-5">
          {songData?.sections[1].type === 'LYRICS'
            ...
            : (
              <p className="text-gray-400 text-base my-1">Sorry, No lyrics found!</p> // first we checked for lyrics and if it is there we show the p tag or else if show the other message
            )}
        </div>
      </div>
